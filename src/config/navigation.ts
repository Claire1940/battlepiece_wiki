...
import { Gift, BookOpen, Zap, Sword, Swords, Newspaper, Rocket, MessageCircle } from 'lucide-react'
...
export const NAVIGATION_CONFIG: NavigationItem[] = [
	...
	{ key: 'powers', path: '/powers', icon: Zap, isContentType: true },
